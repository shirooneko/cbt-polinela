        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item <?php if (uri_string() == 'dosen') echo 'active'; ?>">
                        <a href="/dosen" class="menu-link text-success">
                            <i class="menu-icon tf-icons  mdi mdi-view-dashboard-outline"></i>
                            <div>Dashboard</div>
                        </a>
                    </li>

                    <li class="menu-item <?php if (uri_string() == 'dosen/exam') echo 'active'; ?>">
                        <a href="/dosen/exam" class="menu-link text-danger">
