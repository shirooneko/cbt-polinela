            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex justify-content-end align-items-center">
                        <!-- Link Export Soal -->
                        <a href="/dosen/exportQuestions/<?= $id ?>" class="btn btn-secondary btn-sm me-2">Export Soal</a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="/dosen/questionAdd/<?= $dataExam['id_exam'] ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="modalUpdate<?= $question['id_question'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <form action="/dosen/questionUpdate/<?= $question['id_question'] ?>" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id_exam" value="<?= $dataExam['id_exam'] ?>">
                            <div class="row">
                                <div class="col-md-12 mb-5">
                                    <h5>Soal Ujian</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div>
                            <a href="/assets/file/import_soal.xlsx" download="Import_Mahasiswa.xlsx" class="btn btn-success">
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="/dosen/importQuestion/<?= $id ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "/dosen/questionDelete/" + id;
            } else {
