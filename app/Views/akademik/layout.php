        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/akademik" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    <li class="menu-item <?php if (uri_string() == '/akademik') echo 'active'; ?>">
                        <a href="/akademik" class="menu-link text-success">
                            <i class="menu-icon tf-icons  mdi mdi-view-dashboard-outline"></i>
                            <div>Dashboard</div>
                        </a>
                    </li>

                    <li class="menu-item <?php if (uri_string() == 'akademik/exam') echo 'active'; ?>">
                        <a href="/akademik/exam" class="menu-link text-danger">
                            <i class="menu-icon tf-icons mdi mdi-book-outline"></i>
                            <div>Lihat Data Nilai</div>
                        </a>
                    </li>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="/assets/images/akademik/<?= session('foto') ?>" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                                        ...
                                        <a class="dropdown-item" href="pages-account-settings-account.html">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="/assets/images/dosen/<?= session('foto') ?>" alt class="w-px-40 h-auto rounded-circle" />
                                                    </div>
                                                </div>
